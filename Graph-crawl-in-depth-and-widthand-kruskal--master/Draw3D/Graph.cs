...
namespace Draw3D
{
    ...
    public partial class Graph
    {
        ...
        public TypeNode typ_graph = TypeNode.rectangle; // тип графа
            ...
            for (int i = 0; i < Nodes.Length; i++)
            {
                ...
                for (int j = 0; j < Nodes.Length; j++)
                    if (i != j)
                    {
                        ...
                        L++;
                        Array.Resize<Edge>(ref Nodes[i].Edge, L);
                        Nodes[i].Edge[L - 1] = e;
                    }
            }
        }
                    ...
                    for (int j = 0; j < L; j++)
                    {
                        ...
                        if (m == -1)
                        {
                            ...
                            if (Nodes[NumNode].Edge == null)
                                Nodes[NumNode].Edge = new Edge[0];
                            {
                                Le = Nodes[NumNode].Edge.Length;
                                Array.Resize<Edge>(ref Nodes[NumNode].Edge, ++Le);
        ...
        public void AddEdge()  // добавить ребро
        {
            ...
            Array.Resize<Edge>(ref SelectNodeBeg.Edge, ++L);
        ...
        public void DelEdge(int NumNode, int NumEdge)  // удалить ребро
        {
            ...
            Array.Resize<Edge>(ref Nodes[NumNode].Edge, L - 1);
        }
    }
}
